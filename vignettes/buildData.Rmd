...
recode_rules <- list(
  ...
  list(column = "ASU356", recode_rules = five_n,   new_column = "violence"),
...
# The pretest
  ...
  list(column = "BYU316a", recode_rules = five_n,   new_column = "violence1"),
  ...
  list(column = "BYU316b", recode_rules = five_n,   new_column = "violence2"),
