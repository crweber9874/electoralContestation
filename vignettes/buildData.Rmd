...
## Code Survey items
recode_rules <- list(
  list(column = "ASU351", recode_rules = five_r,   new_column = "attend_march"),
  list(column = "ASU352", recode_rules = five_r,   new_column = "burn_flag"),
  list(column = "ASU353", recode_rules = five_r,   new_column = "court"),
  list(column = "ASU354", recode_rules = five_r,   new_column = "recount"),
  list(column = "ASU355", recode_rules = five_r,   new_column = "criticize_election"),
  list(column = "ASU356", recode_rules = five_r,   new_column = "violence"),
