...
recode_rules <- list(
  ...
  list(column = "vote_2020", recode_rules = c("1" = 1, "2" = 0), new_column = "voted"),
  ...
  list(column = "free_and_fair", recode_rules = five_r, new_column = "free_and_fair"),
  list(column = "vote_confidence", recode_rules = five_r, new_column = "vote_confidence"),
  ...
  list(column = "rr1", recode_rules = four_n, new_column = "rr1"),
  list(column = "rr2", recode_rules = four_r, new_column = "rr2"),
  list(column = "rr3", recode_rules = four_r, new_column = "rr3"),
  list(column = "rr4", recode_rules = four_r, new_column = "rr4"),
  list(column = "pid7", recode_rules = c(
...
wss20$pre_post_election <- NA
wss20$pre_post_election <- ifelse(wss20$post_call == 0 & wss20$uncertainty == 0, 1, wss20$pre_post_election)
wss20$pre_post_election <- ifelse(wss20$post_call == 0 & wss20$uncertainty == 1, 2, wss20$pre_post_election)
wss20$pre_post_election <- ifelse(wss20$post_call == 1 & wss20$uncertainty == 1, 3, wss20$pre_post_election)
...
## Code Survey items
recode_rules <- list(
  list(column = "ASU351", recode_rules = five_r,   new_column = "attend_marchpre"),
  list(column = "ASU352", recode_rules = five_r,   new_column = "burn_flagpre"),
  list(column = "ASU353", recode_rules = five_r,   new_column = "courtpre"),
  list(column = "ASU354", recode_rules = five_r,   new_column = "recountpre"),
  list(column = "ASU355", recode_rules = five_r,   new_column = "criticize_electionpre"),
  list(column = "ASU356", recode_rules = five_r,   new_column = "violencepre"),
  ...
  list(column = "ASU417", recode_rules = five_r,   new_column = "violence1"),
  ...
  list(column = "ASU423", recode_rules = five_r,   new_column = "violence2"),
  ...
  list(column = "ASU429", recode_rules = five_r,   new_column = "violence3"),
  list(column = "ASU429", recode_rules = five_r,   new_column = "violence3"),
...
recode_rules <- list(
# The pretest
  list(column = "BYU311a", recode_rules = five_r,   new_column = "attend_march1"),
  list(column = "BYU312a", recode_rules = five_r,   new_column = "burn_flag1"),
  list(column = "BYU313a", recode_rules = five_r,   new_column = "court1"),
  list(column = "BYU314a", recode_rules = five_r,   new_column = "recount1"),
  list(column = "BYU315a", recode_rules = five_r,   new_column = "criticize_election1"),
  list(column = "BYU316a", recode_rules = five_r,   new_column = "violence1"),
  list(column = "BYU311b", recode_rules = five_r,   new_column = "attend_march2"),
  list(column = "BYU312b", recode_rules = five_r,   new_column = "burn_flag2"),
  list(column = "BYU313b", recode_rules = five_r,   new_column = "court2"),
  list(column = "BYU314b", recode_rules = five_r,   new_column = "recount2"),
  list(column = "BYU315b", recode_rules = five_r,   new_column = "criticize_election2"),
  list(column = "BYU316b", recode_rules = five_r,   new_column = "violence2"),
...
```{r}
bind_rows(avp23, avp24, wss20, wss24, cesASU, cesBYU) %>% 
  select(black, white, asian, american_indian,  latino, age,
         married, college, faminc, state, year, survey, 
         caseidID, caseidID22, survey, year,
         attend_march, burn_flag, court, recount, criticize_election, 
         auth_1, auth_2, auth_3, auth_4, party3, christian,
         post_experimental_condition, experimental_condition_post, 
         experimental_condition_pre,
         pre_post_election) -> electoral_contestation
# data
save(electoral_contestation, file = "~/Dropbox/github_repos/electoralContestation/data/electoral_constestation.rda")
