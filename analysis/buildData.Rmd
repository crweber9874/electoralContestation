...
recode_rules <- list(
  ...
  list(column = "WSS029_a", recode_rules = five_r,   new_column = "contestation_attend_march_1"),
  list(column = "WSS029_b", recode_rules = five_r,   new_column = "contestation_burn_flag_1"),
  list(column = "WSS029_c", recode_rules = five_r,   new_column = "contestation_court_1"),
  list(column = "WSS029_d", recode_rules = five_r,   new_column = "contestation_recount_1"),
  list(column = "WSS029_e", recode_rules = five_r,   new_column = "contestation_criticize_election_1"),
  list(column = "WSS029_f", recode_rules = five_r,   new_column = "contestation_concede_1"),
  list(column = "WSS029_g", recode_rules = five_r,   new_column = "contestation_occupy_buildings_1"),
  list(column = "WSS029_h", recode_rules = five_r,   new_column = "contestation_object_eligibility_1"),
...
# prepare data for long pivot with missing values
wss24 %>% 
  mutate(contestation_attend_march_1 = ifelse(prepost =="pre", contestation_attend_march_1, NA),
         contestation_criticize_election_1 = ifelse(prepost =="pre", contestation_criticize_election_1, NA),
         contestation_burn_flag_1 = ifelse(prepost =="pre", contestation_burn_flag_1, NA),
         contestation_recount_1 = ifelse(prepost =="pre", contestation_recount_1, NA),
         contestation_court_1 = ifelse(prepost =="pre", contestation_court_1, NA),
         contestation_attend_march_2 = ifelse(prepost =="post", contestation_attend_march_1, NA),
         contestation_criticize_election_2 = ifelse(prepost =="post", contestation_criticize_election_1, NA),
         contestation_burn_flag_2 = ifelse(prepost =="post", contestation_burn_flag_1, NA),
         contestation_recount_2 = ifelse(prepost =="post", contestation_recount_1, NA),
         contestation_court_2 = ifelse(prepost =="post", contestation_court_1, NA)) -> wss24
...
recode_rules <- list(
  ...
  # The pretest, conditions 1 and 2
  list(column = "BYU400", recode_rules = five_r,   new_column = "contestation_attend_march_2"),
  list(column = "BYU401", recode_rules = five_r,   new_column = "contestation_burn_flag_2"),
  list(column = "BYU402", recode_rules = five_r,   new_column = "contestation_court_2"),
  list(column = "BYU403", recode_rules = five_r,   new_column = "contestation_recount_2"),
  list(column = "BYU404", recode_rules = five_r,   new_column = "contestation_criticize_election_2"),
  list(column = "BYU405", recode_rules = five_r,   new_column = "contestation_concede_election_2"),
  list(column = "BYU406", recode_rules = five_r,   new_column = "contestation_occupy_buildings_2"),
  list(column = "BYU407", recode_rules = five_r,   new_column = "contestation_object_eligibility_2"),
  list(column = "BYU300", recode_rules = five_r,   new_column = "contestation_attend_march_1"),
  list(column = "BYU301", recode_rules = five_r,   new_column = "contestation_burn_flag_1"),
  list(column = "BYU302", recode_rules = five_r,   new_column = "contestation_court_1"),
  list(column = "BYU303", recode_rules = five_r,   new_column = "contestation_recount_1"),
  list(column = "BYU304", recode_rules = five_r,   new_column = "contestation_criticize_election_1"),
  list(column = "BYU305", recode_rules = five_r,   new_column = "contestation_concede_election_1"),
  list(column = "BYU306", recode_rules = five_r,   new_column = "contestation_occupy_buildings_1"),
  list(column = "BYU307", recode_rules = five_r,   new_column = "contestation_object_eligibility_1"),
...
```{r}
electoral_contestation_long %>% select(caseidID, caseidID22, year, survey, wave, condition, 
          contestation, contestation_value, metadata,
          party_identification3, christian, ideology5, survey_weight, black,
          white, latino, age, american_indian, asian, faminc, married, female, 
          college, presvote_trump_2020, voted2020, presvote_trump_2016,
          auth_1, auth_2, auth_3, auth_4, 
          rr_1, rr_2, rr_3, rr_4,
          prepost, polMeeting, polSign, polVolunteer, polProtest,
          polOfficial, polDonate, polNone, 
          DATE ) %>%
